                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item"
                                       href="/controllers/dashboard/reservation/listController.php?id=<?= $r['Id_reservations'] ?>&statut=en+attente">
                                        <span class="text-warning">●</span> En attente
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item"
                                       href="/controllers/dashboard/reservation/listController.php?id=<?= $r['Id_reservations'] ?>&statut=confirm%C3%A9e">
                                        <span class="text-success">●</span> Confirmée
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item"
                                       href="/controllers/dashboard/reservation/listController.php?id=<?= $r['Id_reservations'] ?>&statut=annul%C3%A9e">
