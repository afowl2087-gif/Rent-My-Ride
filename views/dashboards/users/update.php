...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="/controllers/dashboard/users/listController.php" class="btn btn-outline-secondary">
    ...
    <div class="card-body">
        <form method="POST" action="">
            ...
            <div class="d-flex gap-2 mt-4">
                ...
                <a href="/controllers/dashboard/users/listController.php" class="btn btn-outline-secondary">Annuler</a>
            </div>
        </form>
    </div>
</div>
