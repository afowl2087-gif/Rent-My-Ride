...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3 mb-0">Modifier le véhicule</h1>
    <a href="/controllers/dashboard/vehicle/listController.php" class="btn btn-outline-secondary">
    ...
    <div class="card-body">
        <form method="POST" action="">
            ...
            <div class="d-flex gap-2 mt-4">
                ...
                <a href="/controllers/dashboard/vehicle/listController.php" class="btn btn-outline-secondary">Annuler</a>
            </div>
        </form>
    </div>
</div>
