...
(10, '2025-07-08', '2025-07-15', 'annulée', 10, 5);
...
(6, 'Admin', 'Root', 'admin@rentmyride.com', '0600000000', '$2y$10$rl28Aow2uGjysmbRcH8Rfup4BcB.N3nVg4ZUp9ltZMD5he83UF7le', 1);
...
INSERT INTO `vehicules` (`Id_vehicules`, `marque`, `model`, `description`, `nom`, `prix`, `disponibilite`, `Id_categories`, `image`) VALUES
(1, 'BMW', 'X5', 'SUV premium puissant et confortable pour longs trajets.', 'BMW X5', 120.00, 1, 1, 'uploads/vehicles/BMW-X5.jpg'),
(2, 'Audi', 'Q7', 'SUV spacieux avec finitions haut de gamme.', 'Audi Q7', 130.00, 1, 1, 'uploads/vehicles/audi-Q7.jpg'),
(3, 'Mercedes', 'Classe E', 'Berline élégante et très confortable.', 'Mercedes Classe E', 95.00, 1, 2, 'uploads/vehicles/mercedes-classe-E.jpg'),
(4, 'Tesla', 'Model S', 'Berline électrique performante et innovante.', 'Tesla Model S', 150.00, 1, 2, 'uploads/vehicles/Tesla-model-S.jpg'),
(5, 'Renault', 'Clio V', 'Citadine économique idéale pour la ville.', 'Renault Clio V', 45.00, 1, 3, 'uploads/vehicles/renault-clio-V.jpg'),
(6, 'Peugeot', '208', 'Petite voiture pratique et facile à conduire.', 'Peugeot 208', 50.00, 1, 3, 'uploads/vehicles/peugeot-208.jpg'),
(7, 'Porsche', '911 Carrera', 'Voiture sport emblématique très performante.', 'Porsche 911', 250.00, 1, 4, 'uploads/vehicles/porsche-911-carrera.jpg'),
(8, 'BMW', 'M4', 'Coupé sportif puissant et précis.', 'BMW M4', 220.00, 1, 4, 'uploads/vehicles/bmw-M4.jpg'),
(9, 'Renault', 'Kangoo', 'Utilitaire pratique pour transport et travail.', 'Renault Kangoo', 60.00, 1, 5, 'uploads/vehicles/renault-kangoo.jpg'),
(10, 'Ford', 'Transit', 'Fourgon utilitaire grand volume.', 'Ford Transit', 80.00, 1, 5, 'uploads/vehicles/ford-transit.jpg');
